...
* **31. AVL - Insert**
  * [121-avl_insert.c](./121-avl_insert.c): C function that inserts a value in an 
  AVL tree.
...
* **33. AVL - Remove**
  * [123-avl_remove.c](./123-avl_remove.c): C function that removes a node from an 
  AVL tree.
  * If the node to be deleted has two children, it must be replaced with its first 
  in-order successor.
  * Returns a pointer to the new root node of the tree after removing the desired 
  value, and after rebalancing.

* **34. AVL - From sorted array**
  * [124-sorted_array_to_avl.c](./124-sorted_array_to_avl.c): C function that builds 
...
* **36. Is Binary heap**
  * [130-binary_tree_is_heap.c](./130-binary_tree_is_heap.c): C function that checks if 
  a binary tree is a valid [Max Binary Heap](https://en.wikipedia.org/wiki/Binary_heap).
  * Returns `1` if tree is a valid Max Binary Heap, and `0` otherwise.

* **37. Heap - Insert**
  * [131-heap_insert.c](./131-heap_insert.c): C function that inserts a value in Max 
  Binary Heap.
  * Returns a pointer to the created node, or `NULL` on failure.

* **38. Heap - Array to Binary Heap**
  * [132-array_to_heap.c](./132-array_to_heap.c): C function that builds a Max Binary 
  Heap tree from an array.
  * Return pointer to the root node of the created Binary Heap, or `NULL` on failure.

* **39. Heap - Extract**
  * [133-heap_extract.c](./133-heap_extract.c): C function that extracts the root node 
  of a Max Binary Heap.
  * Returns the value stored in the root node.
  * The root node must be freed and replace with the last level-order node of the heap.

* **40. Heap - Sort**
  * [134-heap_to_sorted_array.c](./134-heap_to_sorted_array.c): C function that converts 
